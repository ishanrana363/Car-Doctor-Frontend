...
const ServiceUpdate = () => {
    ...
    const { data: singleServiceData = {}, refetch, isLoading } = useQuery({
        queryKey: "singleServiceData",
        queryFn: async () => {
    ...
    const { img: upcommingImgUrl } = singleServiceData;
    ...
    const handleSubmit = async (e) => {
        ...
        if (resp.isConfirmed) {
            try {
                ...
                let res = await axiosPublic.put(`/service/${id}`, payload);
    ...
    return (
        <>
            <Helmet>
                <title>Dashboard | Service Update</title>
            </Helmet>
                    ...
                    <div className='flex items-center justify-between gap-8   ' >
                        ...
                        <div className="mb-4 w-full ">
                            ...
                            <input
                                ...
                                defaultValue={singleServiceData?.service_name}
                            />
                        </div>
                        ...
                        <div className="mb-4 w-full ">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                defaultValue={singleServiceData?.service_price}
                            />
                        </div>
                    </div>
                    ...
                    <div className='flex gap-8' >
                        ...
                        <div className="mb-4 w-1/2 ">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                defaultValue={singleServiceData?.service_title}
                            />
                        </div>
                        {/* service_type */}
                        <div className="mb-4 w-1/2 ">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                defaultValue={singleServiceData?.service_type}
                            />
                        </div>
                    </div>
                    <div className="mb-4 ">
                        ...
                        <textarea
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                            rows="7"
                            defaultValue={singleServiceData?.product_description}
                        ></textarea>
                    </div>
